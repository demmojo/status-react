...
let
  sources = {
    ...
    "inquirer-6.4.0" = {
      ...
      version = "6.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/inquirer/-/inquirer-6.4.0.tgz";
        sha512 = "O3qJQ+fU/AI1K2y5/RjqefMEQTdJQf6sPTvyRA1bx6D634ADxcu97u6YOUciIeU2OWIuvpUsQs6Wx3Fdi3eFaQ==";
      };
    };
    "interpret-1.2.0" = {
      name = "interpret";
